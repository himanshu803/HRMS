...
angular.module('myApp.employee.changePassword', ['ngRoute', 'angular-growl'])
  ...
  .controller('changePasswordCtrl', ['$rootScope','$scope','$http','growl', function ($scope, $rootScope, $http, growl) {
    ...
    $scope.changePassword = function () {
      ...
      $http.get("http://192.168.1.130:8080/hrms/hrms_REST/changePassword/?id="+changePasswordData.id+"&oldPassword="+changePasswordData.oldPassword+"&newPassword="+changePasswordData.newPassword+"")
